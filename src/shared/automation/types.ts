...
export type WaitingReason = 'otp' | 'captcha' | 'mfa' | 'anti_bot' | 'unknown_page' | 'missing_field_mapping' | 'stale_mapping' | 'value_mismatch' | 'value_conflict' | 'document_upload_required' | 'session_expired' | 'validation_error' | 'user_paused';
